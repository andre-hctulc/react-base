...
interface PencilIconProps extends Omit<PropsOf<typeof Icon>, "children"> {}

export const PencilIcon = React.forwardRef<HTMLElement, PencilIconProps>((props, ref) => {
    return (
        <Icon ref={ref} {...props}>
            <svg
...
PencilIcon.displayName = withPrefix("PencilIcon");
