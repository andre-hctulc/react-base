...
export const Checkbox = ({ className, size, onChange, value, defaultValue, required, disabled, readOnly, color, icon, ...props }) => {
    const dis = readOnly || disabled;
    return (_jsx(BaseCheckbox, { disabled: dis, onChange: (checked) => onChange?.({ value: checked }), className: checkbox({ className, disabled: dis, color, size }), ...props, checked: value, defaultChecked: defaultValue, children: _jsx("span", { className: "group-data-checked:flex hidden items-center justify-center h-full", children: _jsx(Icon, { size: "sm", children: icon || _jsx(CheckFactIcon, {}) }) }) }));
};
