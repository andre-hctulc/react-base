...
export const Button = React.forwardRef(({ children, color, variant, className, size, loading, iconPosition, icon, shape, disabled, shadow, mt, as, href, ...props }, ref) => {
    const _variant = variant || "filled";
    const _color = color || "primary";
    const ico = loading ? _jsx(Spinner, { color: "inherit", size: "sm" }) : icon;
    ...
    return (_jsxs(Comp, { ref: ref, className: btn({
            className: [
                bgColor,
            ...
            mt,
            disabled: _disabled,
        }), disabled: _disabled, ...p, children: [ico && iconPosition === "left" && _jsx(Icon, { children: ico }), children, ico && iconPosition !== "left" && _jsx(Icon, { children: ico })] }));
});
...
export const IconButton = React.forwardRef(({ children, className, loading, disabled, size, ...props }, ref) => {
    return (_jsx(Button, { color: "neutral", variant: "text", className: iconButton({ className, size }), disabled: loading || disabled, ref: ref, size: size, ...props, children: loading ? _jsx(Spinner, { color: "inherit", size: "inherit" }) : children }));
});
