 ...
 */
export const Overlay = React.forwardRef(({ children, className, variant, noInteraction, bg, portal, zIndex, ...props }, ref) => {
    const over = (_jsx("div", { ref: ref, className: overlay({
            className,
            variant,
            bg,
            zIndex,
    ...
    if (portal)
        return createPortal(over, document.body);
    return over;
});
