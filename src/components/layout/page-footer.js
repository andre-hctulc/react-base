 ...
 */
export const PageFooter = React.forwardRef(({ children, className, as, position, innerSize, padding, variant, shadow, flex }, ref) => {
    const Comp = as || "div";
    return (_jsx(Comp, { className: pageFooter({
            className,
            position,
            shadow,
            variant,
        }), ref: ref, children: _jsx("div", { className: pageFooterInner({ innerSize, padding, flex }), children: children }) }));
});
