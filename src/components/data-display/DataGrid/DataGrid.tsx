...
import Placeholder from "@react-client/components/data-display/loading/Placeholder/Placeholder";
                    ...
                    heading:
                        props.selectAll === false ? undefined : (
                            <input
                                ...
                                checked={allChecked}
                                onChange={e => {
                                    if (e.target.checked) setSelectedRows(props.rows);
                                    ...
                                    {!props.noHeaderRow && (
                                        ...
                                        >
                                            {typeof col.heading === "string" ? (
                                                <ShortText tag="strong" className="px-2 text-sm max-w-full">
                                                    {col.heading}
                                                </ShortText>
                                            ) : (
                                                col.heading
                                        ...
                                        return (
                                            ...
                                            >
                                                {typeof custom === "string" || !custom ? (
                                                    <ShortText variant="body2" className="px-1 max-w-full">
