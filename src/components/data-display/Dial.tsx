...
export interface DialItemProps<T extends Element = Element> {
    ...
    /** Wird nur weitergegeben, falls `forwardDist=true` ist */
    dist?: number;
    /**
     * _Scale Faktor_
     *
     *  Wird nur weitergegeben, falls `forwardScale=true` ist
     * */
    scale?: number;
}
...
interface DialProps {
    ...
    loading?: boolean;
    vertical?: boolean;
    /** Größe der Child-Elemente. Höhe und/oder Breite können auch _undefined_ sein, um etwa nur auf witergegebene props zu reagieren, oder um nur eine Dimension zu verändern. */
    itemSize: { height: number | undefined; width: number | undefined };
    /** @default "medium" */
    spacing?: Size;
    /**
     * Die Spanne, die die Items maximal schrumpfen
     *
     * `0 < maxItemShrink < 1`
     *
     * Nur aktiv, wenn `scale` nicht definiert ist
     *
     * @default 0.5
     * */
    maxItemShrink?: number;
    /**
     * Bis zu dieser Distanz werden children skaliert. Ab dieser Distanz ist die Größe dann konstant (konstanst geschrunpft).
     *
     * **Der Wert sollte nicht zu groß sein, da die Item-Größen alle einmalig bestimmt werden!**
     *
     * @default 10
     * */
